...
export const completeOnboarding = async (userId) => {
  ...
  const res = await safeRequest(() => api.post('/api/users/onboarding-complete', {step: 'welcome'}));
  return res.success;
};
...
export const completeProfileSetup = async (userId) => {
  ...
  const res = await safeRequest(() => api.post('/api/users/profile-setup-complete', {completed: true}));
  return res.success;
};
...
export const skipProfileSetup = async (userId) => {
  ...
  const res = await safeRequest(() => api.post('/api/users/profile-setup-skip', {skipped: true}));
  return res.success;
};
...
export const completePermissions = async (userId, payload) => {
  ...
  const res = await safeRequest(() => api.post('/api/users/permissions-complete', payload || {}));
  return res.success;
};
