/** CJS — see workerDocumentResolver.js */
...
function isImmunisationHistoryDocument(doc) {
...
function buildDocumentCatalogKeyMap(documents = []) {
  const map = new Map();
...
function resolveDocumentCatalogKey(doc, keyMap) {
  if (!doc) return null;
