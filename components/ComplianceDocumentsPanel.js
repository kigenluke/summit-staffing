    ...
    >
      <Text
        style={{
          ...
          fontSize: isPlus ? 26 : 18,
          textAlign: 'center',
          width: 42,
          ...(Platform.OS === 'web' ? { lineHeight: 42 } : { includeFontPadding: false }),
        }}
      >
        {meta.icon}
      </Text>
  ...
  return (
    <View>
      ...
      >
        ...
        <View style={{ flexDirection: Platform.OS === 'web' ? 'row' : 'column', gap: Spacing.sm, marginTop: Spacing.md }}>
          <ComplianceDateField
